    ...
    <footer className="relative pt-40 pb-14 px-6 overflow-hidden">
      ...
      <div ref={ref} className="relative max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <a
            href="#cursos"
            className="px-8 py-4 border border-white/12 text-white/70 rounded-full font-medium hover:border-white/25 hover:bg-white/[0.04] hover:text-white transition-all duration-200"
          >
